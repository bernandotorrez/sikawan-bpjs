								...
								<div class="row">
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<input type="text" name="value2" id="value2" class="form-control hitung" min="0" placeholder="Masukkan Nilai" onkeypress="return onlyNumberKey(event)" onkeyup="return numberWithCommas(this)" required />
										</div>
										<div class="form-group">
											<label for="value3">Tarif INA_CBG Kelas 2</label>
											<input type="text" name="value3" id="value3" class="form-control hitung" min="0" placeholder="Masukkan Nilai" onkeypress="return onlyNumberKey(event)" onkeyup="return numberWithCommas(this)" required />
