...
class Master extends CI_Controller {
	...
	function index(){
		...
		$config['base_url'] = site_url().'master/index/';
		$config['total_rows']= $this->model_master->display_data()->num_rows();
		$config['per_page'] = 10;
		...
		$data = array(
				'title' => 'Master',
				'paging' => $data_paging,
				'record' => $this->model_master->display_data_paging($halaman,$config['per_page']),
			);
		$this->load->view('page_master', $data);
	}
	...
	function input(){
        ...
        $this->session->set_flashdata('inputValidationF', "<strong>Error!</strong>".validation_errors());
				...
				$this->model_master->input($data_input);
	...
	function edit(){
        ...
        $this->session->set_flashdata('inputValidationF', "<strong>Error!</strong>".validation_errors());
				...
				$this->model_master->edit($data_input,$id);
	...
	function excel(){
			...
			$data['record'] = $this->model_master->display_data();
	...
	function pdf(){
		...
		$data = $this->model_master->display_data();
